...
func main() {
	...
	http.HandleFunc("/readerboard/v1/dim", readerboard.WrapHandler(readerboard.Dim, configData, true))
	...
	http.HandleFunc("/readerboard/v1/morse", readerboard.WrapHandler(readerboard.Morse, configData, true))
	...
	http.HandleFunc("/readerboard/v1/sound", readerboard.WrapHandler(readerboard.Sound, configData, true))
	...
	http.HandleFunc("/readerboard/v1/save", readerboard.WrapHandler(readerboard.Save, configData, true))
