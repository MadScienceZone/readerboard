...
\begin{center}\bfseries
	For readerboard hardware (\acronym{PCB}) version 3.2.2, schematic version 3.2.3, and firmware version 0.0.0.
\end{center}
...
As of this writing, the current revision of this board is schematic version 3.2.3 and \acronym{PCB} version 3.2.2.
...
Version 3.2 expands the number of logical rows due to the \acronym{RGB} implementation, which requires
