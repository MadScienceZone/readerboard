...
\begin{table}
	\begin{center}
		\begin{tabular}{lcll}\toprule
			...
			\z{query}&\z{?} & Query discrete \led\ status & [1] [2]\\
			...
			\z{query}&\z{Q} & Query matrix display status & [2]\\
...
\\
\begin{Coding}
	|/readerboard/v1/query?a=|\Var*{ad}|&status|
\end{Coding}
\end{center}
...
\begin{table}
	\begin{center}
		\begin{tabular}{r|c|c|c|c|c|c|c|c|l}
			...
			\emph{22x}&\tiny{AM}&\tiny{PM}&$^\circ$F&$^\circ$C&wide \OE&wide \oe&\tUnused&\tUnused&\multirow{2}{*}{\z{9}\emph{x}}\\\cline{1-9}
