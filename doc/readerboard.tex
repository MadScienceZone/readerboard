...
Otherwise, 3.2.2 boards full function the same as the 3.2.3 revision.
...
image for different microcontrollers (and possibly, in the future, different board revisions).
...
will be driving your \acronym{LED}s regardless of their actual color), or make a firmware change
so that the readerboard disregards any color specification except black, lighting up the single-color
\acronym{LED}s for all other colors.
