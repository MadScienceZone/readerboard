...
\begin{table}
	\begin{center}
		\begin{tabular}{lcll}\toprule
			...
			\z{dim}&\z{D}&Set light dimmer levels & [6]\\
			...
			\noindent[6] Not supported by Busylight units
		\end{tabular}
...
value. \Var*{dim$_m$} is the dimmer value for the \led\ matrix (or ``\z{\_\_}'' if this unit has no matrix),
