...
\begin{table}
	\begin{center}
		\begin{tabular}{r|c|c|c|c|c|c|c|c|l}
			...
			\emph{26x}&\trigram{0}&\trigram{1}&\trigram{2}&\trigram{3}&\trigram{4}&\trigram{5}&\trigram{6}&\trigram{7}&\multirow{2}{*}{\z{B}\emph{x}}\\\cline{1-9}
...
\begin{table}
	\begin{center}
		\begin{tabular}{ll}\toprule
			...
			\z{\{color}\Var*{n}\z{\}}& Switch to color number \Var*{n} (= \z{\textasciicircum K}\Var*{n})\\
			\z{\{}\Var*{colorname}\z{\}}& Switch to color by name\\
			\z{\{date\}}&Date as ``\Var*{dd}\z-\Var*{mmm}\z-\Var*{yyyy}''\\
			\z{\{font}\Var*{n}\z{\}}& Switch to font number \Var*{n} (= \z{\textasciicircum F}\Var*{n})\\
