...
\begin{center}
\begin{bytefield}[endianness=little,bitwidth=0.11111\textwidth]{4}
	\wordbox{1}{7 Application}\\
	\wordbox{1}{\color{grey}6 Presentation}\\
	\wordbox{1}{\color{grey}5 Session}\\
	\wordbox{1}{4 Transport}\\
	\begin{rightwordgroup}{USB or RS-485 + USART}
	\wordbox{1}{3 Network}\\
	\wordbox{1}{2 Data Link}\\
	\wordbox{1}{1 Physical}
	\end{rightwordgroup}
\end{bytefield}
\end{center}
...
``\z{M}'' for \Var*{width}$\times$\Var*{height} matrix display hardware with monochrome \led s, or
``\z{C}'' for \Var*{width}$\times$\Var*{height} \acronym{RGB} color display boards.
...
\begin{Coding}
	|/readerboard/v1/alpha?a=|\Var*{ad}|&pos=|\Var*{pos}|&t=|\Var*{text}
\end{Coding}
\end{center}
...
left of \Var*{pos} or to the right of the \Var*{text} are left unchanged. A period (``\z.'') character
...
\begin{Coding}
	|/readerboard/v1/alpha?a=|\Var*{ad}|&loop=|\Var*{bool}|&scroll&t=|\Var*{text}
\end{Coding}
\end{center}

As above, but replaces all previous character values with the \Var*{text} string, which scrolls
continuously across the display. If \Var*{loop} is ``\z{L}'', the message will continue scrolling;
if it is ``\z.'' then it will scroll into view and stop.
...
\begin{Coding}
	|/readerboard/v1/alpha?a=|\Var*{ad}|&pos=|\Var*{pos}|&bitmap=|\Var*{bitmap}
\end{Coding}
\end{center}

As with ``\z{VA}'', but rather than use a text string, each character value is given by a two-byte big-endian binary value that provides
...
\begin{Coding}
	|/readerboard/v1/alpha?a=|\Var*{ad}|&pos=|\Var*{pos}|&clearto=|\Var*{end}
\end{Coding}
\end{center}
...
\begin{Coding}
	|/readerboard/v1/alpha?a=|\Var*{ad}|&clear|
\end{Coding}
\end{center}
