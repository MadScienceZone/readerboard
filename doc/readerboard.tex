...
\begin{center}\bfseries
	For readerboard hardware version 2.0.0, and firmware version 0.0.0.
\end{center}
...
Alternatively, a command may be targetted to multiple signs by starting the command
...
\begin{table}
	\begin{center}
		...
		\led s will match the custom color arrangement for that sign.}
...
%	\bitheader{0-8} \\
	...
	\bitbox{1}{\z{B}} &
	\bitbox{1}{\z{=}} &
	\bitbox{1}{\color{reservedslot}\rule{\width}{\height}}&
	\bitbox{1}{\Var*{uspd}}&
	\bitbox{1}{\color{reservedslot}\rule{\width}{\height}}&
	\bitbox{1}{\color{reservedslot}\rule{\width}{\height}}&
	\bitbox{1}{\z{\$}} &
